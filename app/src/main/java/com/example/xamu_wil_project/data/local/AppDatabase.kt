...
@Database(entities = [ClientEntity::class, ProjectEntity::class, ProjectDataEntity::class, NoteEntity::class, RouteEntity::class, ImageEntity::class, WeatherSoilEntity::class], version = 4, exportSchema = false)
