package com.example.xamu_wil_project.ui.theme

import androidx.compose.ui.graphics.Color

// Light theme colors - Nature-inspired wetlands palette
val md_theme_light_primary = Color(0xFF2E7D32) // Deep green
val md_theme_light_onPrimary = Color(0xFFFFFFFF)
val md_theme_light_primaryContainer = Color(0xFFA5D6A7) // Light green
val md_theme_light_onPrimaryContainer = Color(0xFF003300)
val md_theme_light_secondary = Color(0xFF0277BD) // Water blue
val md_theme_light_onSecondary = Color(0xFFFFFFFF)
val md_theme_light_secondaryContainer = Color(0xFFB3E5FC)
val md_theme_light_onSecondaryContainer = Color(0xFF001F2A)
val md_theme_light_tertiary = Color(0xFF6D4C41) // Earth brown
...
val md_theme_light_errorContainer = Color(0xFFFDECEA)
...
// Dark theme colors
val md_theme_dark_primary = Color(0xFF81C784) // Light green
...
val md_theme_dark_secondary = Color(0xFF81D4FA) // Light blue
val md_theme_dark_onSecondary = Color(0xFF001F2A)
val md_theme_dark_secondaryContainer = Color(0xFF01579B)
val md_theme_dark_onSecondaryContainer = Color(0xFFB3E5FC)
val md_theme_dark_tertiary = Color(0xFFBCAAA4) // Light brown
val md_theme_dark_onTertiary = Color(0xFF3E2723)
val md_theme_dark_tertiaryContainer = Color(0xFF5D4037)
